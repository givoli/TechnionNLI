...
public class SystemSanityTest {
  ...
  private static Dataset makeDataset() {
    ...
    d.readFromPathPairs(Collections.singletonList(
        Pair.newPair("train", "src/test/resources/forOriginalSempreTests/freebase/data/unittest-learn.examples")));
    return d;
  }
  ...
  public void easyEndToEnd() {
    ...
    String[] grammarPaths = new String[] {
      "src/test/resources/forOriginalSempreTests/freebase/data/unittest-learn.grammar",
      "src/test/resources/forOriginalSempreTests/freebase/data/unittest-learn-ccg.grammar",
    };
