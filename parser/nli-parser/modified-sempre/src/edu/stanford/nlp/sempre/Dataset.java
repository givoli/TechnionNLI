...
public class Dataset {
  ...
  protected final HashSet<String> tokenTypes = new HashSet<String>(); // changed from private to package-private. --Ofer Givoli
  protected final StatFig numTokensFig = new StatFig();  // For each example, number of tokens
      // changed from private to package-private. --Ofer Givoli
  ...
  protected void readLispTreeHelper(String path, int maxExamples, List<Example> examples) { //changed from private to protected.
  ...
  public List<Example> getAllExamples(){
    return allExamples.values().stream().flatMap(Collection::stream).collect(Collectors.toList());
  }
}
