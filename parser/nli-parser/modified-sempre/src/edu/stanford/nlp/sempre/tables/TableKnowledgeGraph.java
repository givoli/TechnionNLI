...
import com.opencsv.CSVReader; // Modified. --Ofer Givoli
...
public class TableKnowledgeGraph extends KnowledgeGraph {
  ...
  public static class TableColumn { //changed from package-private to public. --Ofer Givoli
  ...
  public static class TableRow {  //changed from package-private to public. --Ofer Givoli
    public final List<TableCell> children;
    public final int index;
  ...
  public static final class TableCell {  // changed from package-private to public. --Ofer Givoli
  ...
  public static class TableCellProperties {  //changed from package-private to public. --Ofer Givoli
  ...
  //changed fields in this class to protected. --Ofer Givoli
  protected List<TableRow> rows;
  protected List<TableColumn> columns;
  protected String filename;

  protected Map<String, TableRow> rowNameToTableRow;
  protected Map<String, TableColumn> columnNameToTableColumn;
  protected Map<String, TableColumn> propertyIdToTableColumn;
  protected Map<String, TableCellProperties> cellIdToTableCellProperties;
  ...
  /**
   * Added this constructor. --Ofer Givoli.
   *
   * This constructor does NOT initiate {@link #fuzzyMatcher}.
   */
  public TableKnowledgeGraph() {
    init();
  }
  ...
  TableKnowledgeGraph(String filename) {
    ...
    try (CSVReader csv = new CSVReader(new FileReader(filename))) {
      ...
      setFuzzyMatcher(new FuzzyMatcher(this)); // factored out. --Ofer Givoli
    } catch (Exception e) {
      throw new RuntimeException(e);
    }
  }

  // Factored out. --Ofer Givoli
  public void setFuzzyMatcher(FuzzyMatcher fuzzyMatcher) {
    this.fuzzyMatcher = fuzzyMatcher;
  }

  /**
   * This method was factored out. --Ofer Givoli
   *
   * This method does NOT initiate {@link #fuzzyMatcher}.
   */
  private void init() {
    rows = new ArrayList<>();
  ...
  private static final Map<String, TableKnowledgeGraph> filenameToGraph = new HashMap<>();
  ...
  // Changed return type from Collection to List and edited body accordingly (see note in the abstract method). --Ofer Givoli
  @Override
  public LinkedList<Formula> getFuzzyMatchedFormulas(String term, FuzzyMatchFn.FuzzyMatchFnMode mode) {
    return new LinkedList<>(fuzzyMatcher.getFuzzyMatchedFormulas(term, mode));
  }

  // Changed return type from Collection to List and edited body accordingly (see note in the abstract method). --Ofer Givoli
  @Override
  public LinkedList<Formula> getAllFormulas(FuzzyMatchFn.FuzzyMatchFnMode mode) {
    return new LinkedList<>(fuzzyMatcher.getAllFormulas(mode));
  }
