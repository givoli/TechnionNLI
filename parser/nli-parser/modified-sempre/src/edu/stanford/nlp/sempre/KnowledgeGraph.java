...
public abstract class KnowledgeGraph {
  ...
  // Changed this from Collection to List because LazyFuzzyMatchFnDerivs#createDerivation assumes deterministic order. --Ofer Givoli
  /** Return all entities / unaries / binaries that approximately match the given term */
  public abstract List<Formula> getFuzzyMatchedFormulas(String term, FuzzyMatchFn.FuzzyMatchFnMode mode);

  //Changed this from Collection to List because LazyFuzzyMatchFnDerivs#createDerivation assumes deterministic order. --Ofer Givoli
  /** Return all entities / unaries / binaries */
  public abstract List<Formula> getAllFormulas(FuzzyMatchFn.FuzzyMatchFnMode mode);
