...
public abstract class TableTypeSystem {
  ...
  public static final NameValue ROW_NEXT_VALUE = new NameValue("next"); // Changed "fb:row.row.next" to "next". --Ofer Givoli
  public static final NameValue ROW_INDEX_VALUE = new NameValue("index"); // Changed "fb:row.row.index" to "index". --Ofer Givoli
