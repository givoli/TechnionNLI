...
public class LambdaDCSExecutorTest {
  ...
  protected static KnowledgeGraph getKnowledgeGraph(String name) {
    if ("simple".equals(name)) {
      ...
      return TableKnowledgeGraph.fromFilename("src/test/resources/forOriginalSempreTests/tables/toy-examples/random/nikos_machlas.csv"); // Changed path. --Ofer Givoli
    }
