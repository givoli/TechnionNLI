...
public class SemTypeHierarchy {
  ...
  public SemTypeHierarchy() {
    ...
    // Added code: from this line until end of method. --Ofer Givoli

    addEntitySupertypes(InstructionTypeSystem.AtomicTypeNames.USER_ENTITY);
    addEntitySupertypes(InstructionTypeSystem.AtomicTypeNames.NLI_ENTITY);

    addSupertype(InstructionTypeSystem.AtomicTypeNames.NLI_ENTITY_TYPE,
            InstructionTypeSystem.AtomicTypeNames.NLI_ENTITY_TYPE);
    addSupertype(InstructionTypeSystem.AtomicTypeNames.NLI_ENTITY_TYPE,CanonicalNames.ANY);
    addSupertype(InstructionTypeSystem.AtomicTypeNames.NLI_METHOD,InstructionTypeSystem.AtomicTypeNames.NLI_METHOD);
    addSupertype(InstructionTypeSystem.AtomicTypeNames.NLI_METHOD,CanonicalNames.ANY);

    addSupertype(InstructionTypeSystem.AtomicTypeNames.NLI_ENTITY, InstructionTypeSystem.AtomicTypeNames.USER_ENTITY);
    addSupertype(CanonicalNames.BOOLEAN, InstructionTypeSystem.AtomicTypeNames.USER_ENTITY);
    addSupertype(CanonicalNames.INT, InstructionTypeSystem.AtomicTypeNames.USER_ENTITY);
    addSupertype(CanonicalNames.FLOAT, InstructionTypeSystem.AtomicTypeNames.USER_ENTITY);
    addSupertype(CanonicalNames.DATE, InstructionTypeSystem.AtomicTypeNames.USER_ENTITY);
    addSupertype(CanonicalNames.TEXT, InstructionTypeSystem.AtomicTypeNames.USER_ENTITY);
    addSupertype(CanonicalNames.NUMBER, InstructionTypeSystem.AtomicTypeNames.USER_ENTITY);
  }
