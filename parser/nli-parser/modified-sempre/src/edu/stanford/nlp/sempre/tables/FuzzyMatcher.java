...
public class FuzzyMatcher {
  ...
  protected void precomputeForFuzzyMatching() {
    ...
    for (TableColumn column : graph.getColumns()) { //changed graph field to a getter. --Ofer Givoli
      // unary and binary
  ...
  /**
   * @return false iff 'term' should not be used.
   * Added this documentation, made this method static, and changed it from package private to public. --Ofer Givoli
   */
